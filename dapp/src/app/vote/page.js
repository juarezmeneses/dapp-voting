...
export default function Vote() {
    ...
    function getOption(option) {
        switch (option) {
            case "Juarez": return { name: "Juarez", image: "https://avatars.githubusercontent.com/u/3067971?v=4" };
            case "Regina": return { name: "Regina", image: "https://avatars.githubusercontent.com/u/121307550?v=4" };
